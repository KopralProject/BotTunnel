const servervless = 'xvless.kopralstore.my.id';
const servertrojan = 'trojan.kopralstore.my.id';
const serverwildcard = 'kopralstore.my.id';
const serverList = serverwildcard.split(',');
const passuid = 'STUPID-ERROR-WORLD';
const TELEGRAM_BOT_TOKEN = '8058490630:AAFiyQKYBSFBsfb7N-pLJ-JiTUnuvA2BBag';
