const servervless = 'xvless.kaisaronline.web.id';
const servertrojan = 'trojan.kaisaronline.web.id';
const serverwildcard = 'kaisaronline.web.id';
const serverList = serverwildcard.split(',');
const passuid = 'KAISAR-VPN-SUNDA';
